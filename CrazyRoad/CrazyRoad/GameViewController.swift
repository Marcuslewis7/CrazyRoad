...
class GameViewController: UIViewController {
    ...
    func setupPlayer() {
        guard let playerScene = SCNScene(named: "art.scnassets/Cowboy.scn") else { return }
    ...
    func setupCamera() {
        ...
        cameraNode.eulerAngles = SCNVector3(x: -toRadians(angle: 60), y: toRadians(angle: 25), z: 0)
    ...
    func setupActions() {
        ...
        dieAction = SCNAction.moveBy(x: 0, y: 5, z: 0, duration: 0.5)
